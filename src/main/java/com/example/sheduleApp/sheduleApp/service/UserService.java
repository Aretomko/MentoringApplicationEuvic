...
import com.example.sheduleApp.sheduleApp.exceptions.customExceptions.UserActivationException;
...
//        }
    ...
    public boolean activateUser(String code) {
        ...
        if (user == null) {
           throw new UserActivationException("Wrong activation code provided");
        }
